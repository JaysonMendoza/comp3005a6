...
export default function MonsterTable(props) {
    ...
    let tableItems = props?.monsterList?.map( monster => {
        return (<tr key={monster?.monsterID}>
            ...
            <td className="text-center">{monster?.subType}</td>
            ...
            <td className="text-center">{monster?.languages}</td>
            <td className="text-center">{monster?.numAlternateForms}</td>
            ...
            <Table striped bordered hover>
                <thead>
                    <tr>
                        ...
                        <th className="text-center">Alt Forms</th>
